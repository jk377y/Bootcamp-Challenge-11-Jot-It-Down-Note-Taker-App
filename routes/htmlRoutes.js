...
htmlRouter.get('*', (req, res) => {   // this is a GET request for * (wildcard); if no other routes are requested with the api url, then the index.html is returned to the client
